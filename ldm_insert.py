...
def await_grid(grid_dir, action):
    ...
    dataset_name = "OR_GLM-L2-GLMC-{0}_{1}_s{2}_e{3}_c*.nc".format(
        mode, platform, startdate.strftime('%Y%j%H%M%S0'),
        enddate.strftime('%Y%j%H%M%S0'))
...
if __name__ == '__main__':
    ...
    print(await_grid(args.grid_dir, pqinsert))
